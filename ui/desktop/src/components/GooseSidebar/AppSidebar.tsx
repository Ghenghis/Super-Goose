...
const menuItems: NavigationEntry[] = [
  ...
  },
  {
    ...
    tooltip: 'Critic evaluations and scoring',
  },
  {
    type: 'item',
    path: '/plans',
    label: 'Plans',
    icon: ListChecks,
    tooltip: 'Plan manager and execution steps',
  },
  {
    type: 'item',
    path: '/guardrails',
    label: 'Guardrails',
    icon: ShieldCheck,
    tooltip: 'Safety guardrails and scanning',
  },
  {
    type: 'item',
    ...
    tooltip: 'Feature status dashboard',
  },
  {
    type: 'item',
    path: '/conscious',
    label: 'Conscious',
    icon: Sparkles,
    tooltip: 'Conscious AI personality and voice',
  },
  {
    type: 'item',
    path: '/enterprise',
    label: 'Enterprise',
    icon: Shield,
    tooltip: 'Enterprise security and governance settings',
  },
  { type: 'separator' },
  {
    type: 'item',

...
const COMPACTION_STYLE_ID = '__compaction-indicator-animations';

if (typeof document !== 'undefined' && !document.getElementById(COMPACTION_STYLE_ID)) {
  const style = document.createElement('style');
  style.id = COMPACTION_STYLE_ID;
  style.textContent = `

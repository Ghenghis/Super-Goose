import { memo, useEffect, useRef, useState, useCallback, useMemo, useId } from 'react';
...
const MermaidDiagram = memo(function MermaidDiagram({ code, title }: MermaidDiagramProps) {
  ...
  // Generate a stable unique ID for this diagram (useId is deterministic in StrictMode)
  const reactId = useId();

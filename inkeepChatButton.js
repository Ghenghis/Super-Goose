    ...
    inkeepChatButtonScript.addEventListener("load", function () {
      const inkeepConfigChatButton = {"baseSettings":{"apiKey":"","integrationId":"","organizationId":"","primaryBrandColor":"#1E1E1E"},"aiChatSettings":{"chatSubjectName":"Super-Goose","botAvatarSrcUrl":"","getHelpCallToActions":[{"name":"GitHub","url":"https://github.com/Ghenghis/Super-Goose","icon":{"builtIn":"FaGithub"}}],"quickQuestions":["What is Super-Goose?","How do the 16 tools work?","What is Stage 5?"]}};
